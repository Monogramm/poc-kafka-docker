...
describe('Service Tests', () => {
  describe('Chatroom Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(ChatroomService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Chatroom(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Chatroom', () => {
        ...
        service.create(new Chatroom()).subscribe(resp => (expectedResult = resp.body));

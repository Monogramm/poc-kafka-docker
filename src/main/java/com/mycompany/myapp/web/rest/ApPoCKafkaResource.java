...
@RestController
@RequestMapping("/api/ap-po-c-kafka")
public class ApPoCKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ApPoCKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ApPoCKafkaResource(KafkaProperties kafkaProperties) {
